        ...
        <div className="space-y-8">
          {projects.map((project, index) => (
            <motion.article
              ...
              className="overflow-hidden rounded-3xl glass-card-light"
            >
              <div className="grid gap-0 lg:grid-cols-[1.2fr_0.8fr]">
                <div className="p-8 lg:p-10">
                  ...
                  <p className="mt-5 rounded-2xl glass-card-soft p-4 text-sm text-black/75">{project.summary}</p>
                ...
                <div className="border-l border-black/10 bg-white/50 p-8 lg:p-10">
                  <h4 className="text-xs font-semibold uppercase tracking-[0.25em] text-black/55">Key Features</h4>
                  <ul className="mt-4 space-y-3">
                    {project.features.map((feature) => (
                      <li key={feature} className="rounded-xl glass-card-soft px-4 py-3 text-sm text-black/80">{feature}</li>
                    ))}
                  </ul>
                </div>
              </div>
